...
void loop()
{
    if (buttonClicked())
    {
        auto wylosowanaLiczba1 = millis() % 128;
        auto wylosowanaLiczba2 = millis() % 127;
        auto suma = wylosowanaLiczba1 + wylosowanaLiczba2;

        Wyswietlacz::wyswietlLiczbe(suma);
        Serial.println("nacisnieto Przycisk");
        Serial.println("wylosowanaLiczba1: "+String(wylosowanaLiczba1));
        Serial.println("wylosowanaLiczba2: " + String(wylosowanaLiczba2));
